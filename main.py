from PyQt5.QtWidgets import QApplication, QWidget, QPushButton,  QGridLayout, QFileDialog, QListWidget, QAbstractItemView, QCheckBox
...
class MyApp(QWidget):
    def __init__(self):
        ...
        layout.addWidget(self.sort_check_box, 4, 2)
        layout.addWidget(self.merge_button, 4, 3)
    ...
    def add(self):
        ...
        for i in range(len(files)):
            cleaned_filename = self.clean_file_name(files[i])
